...
spinwalk -c ./../config/gre.ini  ./../config/se.ini ./../config/ssfp.ini ./../config/grase.ini ./../config/stimulated_echo.ini ./../config/gre_save_trajectory.ini ./../config/gradient.ini 
