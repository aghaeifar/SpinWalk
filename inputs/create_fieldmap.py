...
dChi  = 0.273 # susceptibility difference between fully deoxygeneted blood and tissue
...
while True:
    ...
    v2_u = np.asarray([1., 0., 0.], dtype = float) # suppose this is a vector of form [1,0,x], connects point P3 to p1
    ...
    mask_local = np.zeros_like(vessel_mask) # maks for the current vessel
...
sp.io.savemat('fieldmap.mat', mdict={'fieldmap': dW, 'mask': vessel_mask})
