<a href={[https://github.com/Ehyaei/Open-Academic-Graph](https://github.com/aghaeifar/SpinWalk/)}><img src="doc/img/logo.svg" alt="SpinWalk Logo" align="right" width="160" style="padding: 0 15px; float: right;"/>
